...
export class FlatCurveV1AntiSnipeAdapter extends AbstractCurveAdapter {
  private readonly platformFeeBps: number = 100;

  private readonly curve: FlatCurveV1AntiSnipe;
  ...
  constructor(
    ...
    this.curve = new FlatCurveV1AntiSnipe(collateralCollected);
  }
